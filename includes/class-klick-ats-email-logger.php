...
if (class_exists('Klick_Ats_EMAIL_Logger')) return;

/**
 * Class Klick_Ats_EMAIL_Logger
 */
class Klick_Ats_EMAIL_Logger extends Klick_Ats_Abstract_Logger {
	...
	/**
	 * Klick_Ats_EMAIL_Logger constructor
	 */
	...
	public function get_description() {
		return __('Log events into Url address', 'klick-ats');
	}
