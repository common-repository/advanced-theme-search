...
if (class_exists('Klick_Ats_Notifier')) return;

/**
 * Class Klick_Ats_Notifier
 */
class Klick_Ats_Notifier {
	...
	/**
	 * Klick_Ats_PHP_Notifier constructor
	...
	public function __construct() {
		...
		$folder = opendir(KLICK_ATS_PLUGIN_MAIN_PATH . 'notices');
	...
	public function add_noitice($notice_file) {
		...
		$notice_file = KLICK_ATS_PLUGIN_MAIN_PATH . 'notices' . '/' . $notice_file;
